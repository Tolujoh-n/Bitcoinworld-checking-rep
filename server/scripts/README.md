# BitcoinWorld Database Scripts

This directory contains utility scripts for managing the BitcoinWorld database.
...
Connected to: mongodb://localhost:27017/bitcoinworld
...
If not set, defaults to `mongodb://localhost:27017/bitcoinworld`
...
**Created for:** BitcoinWorld Full-Stack Application  
