...
const Chip = ({ type, label = "" }) => {
  ...
  if (type === "featured") {
    return (
      <span className="px-2 py-1 rounded-full text-[11px] font-semibold inline-flex items-center gap-1 bg-bitcoin-100 text-bitcoin-700 dark:bg-bitcoin-900/40 dark:text-bitcoin-300">
